...
// import 'package:student_manager/screens/create_student/widgets/form_fields.dart';
...
class EditDetails extends StatefulWidget {
  ...
  final int index;
   EditDetails({ Key? key,required this.student, required this.index}) : super(key: key);
...
class _EditDetailsState extends State<EditDetails> {
  ...
  void preFilled(){
    ...
    _classController.text = widget.student.std;
    _placeController.text = widget.student.place;
    _Path = widget.student.path;
             ...
             SizedBoxCustom(
               custom: Container(
                 child: Column(
                   ...
                   children: [
                     _image == null ?const Text('please ipload photo') :
                      ClipRRect(
                ...
                child: Column(
                  children: [
                    SizedBox(height: 20,),
                SizedBoxCustom(custom: TextFormField(
                ...
                SizedBox(height: 10,),
                 Center(
                   ...
                   onSubmitButton();
                   getAllStudents();
                   }, icon: Icon(Icons.save_rounded), label: Text('Save File')),
                 )
                  ],
                ),
              )
...
void onSubmitButton() {
  ...
  if (_formKey.currentState!.validate()){
   ...
   box.putAt(widget.index, DBModel(path: _Path, name: _name, age: _age, std: _class, place: _place));
 Navigator.of(context).pop();
  }
